...
The command will accept one or more hostnames of Controllers that will be disabled as an argument. You can get the hostnames by running 'sdpctl appliance stats'.`,
		Examples: []ExampleDoc{
			{
