...
func (a *Appliance) UpgradeStatus(ctx context.Context, applianceID string) (*openapi.AppliancesIdUpgradeGet200Response, error) {
...
func (a *Appliance) UpgradeStatusRetry(ctx context.Context, applianceID string) (*openapi.AppliancesIdUpgradeGet200Response, error) {
	var status *openapi.AppliancesIdUpgradeGet200Response
...
func (a *Appliance) UploadToController(ctx context.Context, url, filename string) error {
	response, err := a.APIClient.ApplianceUpgradeApi.FilesPost(ctx).FilesPostRequest(openapi.FilesPostRequest{
		Url:      url,
		Filename: filename,
	}).Execute()
	if err != nil {
